...
transitive-accessible class    net/minecraft/client/render/VertexConsumers$Union
...
transitive-accessible method   net/minecraft/client/render/entity/GuardianEntityRenderer                  renderBeam           (Lnet/minecraft/client/util/math/MatrixStack;Lnet/minecraft/client/render/VertexConsumer;Lnet/minecraft/util/math/Vec3d;FFF)V
...
transitive-accessible field    net/minecraft/client/gl/RenderPipelines                           TRANSFORMS_PROJECTION_FOG_SNIPPET    Lcom/mojang/blaze3d/pipeline/RenderPipeline$Snippet;
