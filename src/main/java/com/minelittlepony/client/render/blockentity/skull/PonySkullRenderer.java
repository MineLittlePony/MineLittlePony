...
public class PonySkullRenderer {
    ...
    public boolean renderSkull(@Nullable Direction direction,
        ...
        skull.render(stack, vertices, light, OverlayTexture.DEFAULT_UV, Color.argbToHex(ArmourRendererPlugin.INSTANCE.get().getArmourAlpha(EquipmentSlot.HEAD, ArmourLayer.OUTER), 1, 1, 1));
