...
public class MagicOverlayOrderedRenderCommandQueue extends MagicOverlayRenderCommandQueue implements OrderedRenderCommandQueue {
    ...
    public MagicOverlayOrderedRenderCommandQueue(OrderedRenderCommandQueue parent, Function<RenderLayer, @Nullable RenderLayer> layer, int color) {
        super(parent, parent, layer, color);
    }
    ...
    protected MagicOverlayRenderCommandQueue createQueue(RenderCommandQueue parent) {
        return new MagicOverlayRenderCommandQueue(this, parent, layer, color);
    }
}
